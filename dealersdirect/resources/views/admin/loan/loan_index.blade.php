                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeA">
                                            ...
                                            <td>{{$data->terms}}</td>
                                            <td><a class="edt_lnk" href="#" data-action="<?php echo URL::to('/admin/edit-loan');?>/{{$data->id}}" data-whatever="@mdo" data-target="#edit_price_modal" data-toggle="modal"><i class="fa fa-pencil-square" aria-hidden="true"></i></a>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add Loan Details</h4>
        </div>
        <div class="modal-body">
          <form method="POST" action="">
          <label> Rate of Interests</label>
  ...
  <div class="modal fade" id="edit_price_modal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Edit Loan Details</h4>
        </div>
