                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="col-xs-9 col-md-9">{{$RequestQueue->fname}}</div>
                                </div>
                                <div class="row show-grid">
                                <div class="col-xs-3  col-md-3">Last Name</div>
                                <div class="col-xs-9 col-md-9">{{$RequestQueue->lname}}</div>
                                </div>
                                <div class="row show-grid">
                                <div class="col-xs-3  col-md-3">Phone</div>
                                <div class="col-xs-9 col-md-9">{{$RequestQueue->phone}}</div>
                                </div>
                                <div class="row show-grid">
                                <div class="col-xs-3  col-md-3">Email</div>
                                <div class="col-xs-9 col-md-9">{{$RequestQueue->email}}</div>
                                </div>
